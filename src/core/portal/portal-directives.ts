...
export class PortalHostDirective extends BasePortalHost {
  ...
  /** Attach the given ComponentPortal to this PortalHost using the DynamicComponentLoader */
  attachComponentPortal(portal: ComponentPortal): Promise<ComponentRef<any>> {
    portal.setAttachedHost(this);

    // If the portal specifies an origin, use that as the logical location of the component
    // in the application tree. Otherwise use the location of the PortalHost.
  ...
  /** Attach the given TemplatePortal to this PortalHost as embedded View */
