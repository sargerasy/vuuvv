import { TemplateRef, Type, ElementRef, ComponentRef, ViewContainerRef } from '@angular/core';
...
/**
 * Portial implementation of PortalHost that only deals with attaching eigher a
