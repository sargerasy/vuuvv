import { beforeEach, ddescribe, expect, inject, it } from '@angular/core/testing';
...
import { MdProgressCircle } from './progress-circle';
  ...
  describe('MdProgressCircular', () => {
    ...
    it('should app a mode of "determinate" if an invalid mode is provided.', (done:() => void) => {
      builder
    ...
    it('should clamp the value of the progress between 0 to 100', (done: () => void) => {
      builder
        .overrideTemplate(TestApp, '<md-progress-circle></md-progress-circle>')
        .createAsync(TestApp)
        .then((fixture) => {
